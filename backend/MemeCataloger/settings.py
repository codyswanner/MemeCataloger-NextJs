"""
Django settings for MemeCataloger project.
...
SECRET_KEY = 'django-insecure-pqx8+xk((zq7w_$9^fxef)q*g7@u3syfruy_v2ar*+26kxaj*0'
...
ROOT_URLCONF = 'MemeCataloger.urls'
...
WSGI_APPLICATION = 'MemeCataloger.wsgi.application'
